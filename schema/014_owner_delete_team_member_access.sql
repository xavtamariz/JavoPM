-- JavoPM v1.8.0 owner-controlled member deletion.
-- A member must be inactive before deletion. The Edge Function deletes the
-- linked Supabase Auth user after this function removes workspace access.
